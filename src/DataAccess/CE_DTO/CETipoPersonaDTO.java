package DataAccess.CE_DTO;

public class CETipoPersonaDTO {
    ...
    public CETipoPersonaDTO (){}
    public CETipoPersonaDTO (Integer idCatalogo, Integer idCatalogoTipo, String nombre, 
