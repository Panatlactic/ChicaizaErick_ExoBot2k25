...
public abstract class CEAppConfig {
    ...
    static {
        try (InputStream appProperties = new FileInputStream(APP_PROPERTIES)) {
            ...
            CE_CMD.printlnError("ERROR al cargar ❱❱ " + e.getMessage());
        }
    }
    ...
    static String getProperty(String key) {
        ...
        CE_CMD.println("AppConfig ❱❱ "+ APP_PROPERTIES +"." + key + " : "+ path);
        if(path != null)
            return  path;
        else
            CE_CMD.printlnError("ERROR ❱❱ " + APP_PROPERTIES +"." + key + " : "+ path);
        return null;
    }
    ...
    static URL getAppResource(String key) {
        ...
        if(path != null)
            return  CEAppConfig.class.getResource(path);
        else
            CE_CMD.printlnError("ERROR ❱❱ getAppResource : " + APP_PROPERTIES +"." + key + " : "+ path);
        return null;
    }
